...
repository's trusted Linux x64 self-hosted runner for non-PR events when
`USE_SELF_HOSTED_X64=true`. All pull requests and repositories without that
explicit opt-in are routed to GitHub-hosted runners. Runner prerequisites,
