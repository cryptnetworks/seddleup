        ...
        <div className="mt-3 grid gap-2">
          {results.map((result) => (
            <button
              ...
              className="min-h-11 min-w-0 rounded-lg border border-line bg-elevated p-3 text-left text-sm hover:border-ocean focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ocean focus-visible:ring-offset-2"
              type="button"
